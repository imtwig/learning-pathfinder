    ...
    <div className="min-h-screen bg-[rgb(var(--color-background))]">
      ...
      <div className="container mx-auto px-4 sm:px-[var(--space-6)] py-6 sm:py-[var(--space-12)] max-w-7xl">
        ...
        <header className="mb-6 sm:mb-[var(--space-12)] animate-fadeInUp">
          <div className="bg-[rgb(var(--color-surface))] border border-[rgb(var(--color-border))] rounded-xl sm:rounded-2xl p-4 sm:p-[var(--space-8)] shadow-[var(--shadow-lg)] overflow-visible">
