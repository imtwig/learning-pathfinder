...
const SOFTWARE_ENGINEER_LEVELS = [
  ...
  const PATHWAY_COURSES = {
    ...
    'Product Manager': {
      0: {
        Core: [
          { title: 'Product 101 (Product Learning Hub)', url: 'https://www.thedigitalacademy.tech.gov.sg/course/detail/product-101-product-learning-hub' },
          { title: 'Product 201', url: 'https://www.thedigitalacademy.tech.gov.sg/course/detail/product-201' },
        ],
        Elective: [],
      },
      1: {
      ...
      4: {
        ...
        Elective: [
          { title: 'Reforge: Mastering Experimentation', url: null },
          { title: 'Reforge: Mastering Product Analytics', url: null },
          { title: 'Reforge: Building Products with Network Effects', url: null },
          { title: 'AI Evals Certification', url: null },
        ],
      },
    },
    'Product Ops': {
      ...
      4: {
        Core: [
          { title: 'Mastering Product Operations', url: 'https://www.thedigitalacademy.tech.gov.sg/course/detail/mastering-product-operations' },
          { title: 'Product Operating Model and Business Transformation', url: null },
          { title: 'Product Strategy (Advanced)', url: null },
        ],
        Elective: [
          { title: 'Product Operations Certification (3-course series: Foundations + Insight + Product Operations)', url: null },
          { title: 'Product Operations Certified: Masters', url: null },
          { title: 'Systems Thinking Certificate', url: null },
          { title: 'Leading Organizational Change', url: null },
          { title: 'Digital Transformation Strategies for Leaders', url: null },
          { title: 'Facilitating and Leading Cross-Functional Collaboration', url: null },
        ],
      },
    },
...
// Pathway mapping from URL slug to display name
const PATHWAY_MAP: { [key: string]: string } = {
...
function StaffDashboardContent() {
  ...
  const pathwaySlug = params.pathway as string;
  const urlPathway = PATHWAY_MAP[pathwaySlug] || 'UX Designer';
  const userId = '';
  ...
  const pathwayOptions = [
    { value: 'UX Designer', label: 'Designer Pathway', slug: 'ux-designer' },
    { value: 'Product Manager', label: 'Product Manager Pathway', slug: 'product-manager' },
    { value: 'Product Ops', label: 'Product Ops Pathway', slug: 'product-ops' },
    { value: 'Software Engineer', label: 'Software Engineer Pathway', slug: 'software-engineer' },
  ];
                        ...
                        {pathwayOptions
                          ...
                          .map((option) => (
                            <button
                              key={option.value}
                              onClick={() => {
                                router.push(`/informational/${option.slug}`);
                                setPathwaySearchOpen(false);
                                setPathwaySearchQuery('');
                              }}
                              className={`
            ...
            <Card className="shadow-[var(--shadow-lg)] bg-[rgb(var(--color-surface))] overflow-visible">
              <CardHeader className="border-b border-[rgb(var(--color-border))] py-[var(--space-4)]">
                <div className="flex items-start gap-[var(--space-3)]">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-[var(--shadow-sm)] shrink-0 bg-[rgb(var(--color-neutral-100))] text-[rgb(var(--color-neutral-600))]">
